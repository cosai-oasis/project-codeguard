...
- DevinFormat: Generates Agent Skills files for Devin
...
Usage:
    from formats import BaseFormat, ProcessedRule, CursorFormat, WindsurfFormat, DevinFormat, CopilotFormat, AgentSkillsFormat, AntigravityFormat, OpenCodeFormat, CodexFormat, OpenClawFormat, HermesFormat, ClaudeFormat
